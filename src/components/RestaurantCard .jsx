...
const RestaurantCard = ({ resData }) => {
    ...
    return (
        <div className="res-card w-72 h-[450px] text-center  px-6 ml-9 mr-3 mb-8 mt-5 rounded-md bg-slate-200 shadow-inner transform transition-transform duration-200 hover:scale-105 " >
